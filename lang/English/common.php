...
'Bad referrer'						=>	'Bad security token. You were referred to this page from an unauthorized source. If the problem persists please make sure that JavaScript is enabled in your browser.',
